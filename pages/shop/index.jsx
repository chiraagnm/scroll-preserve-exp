...
const ProductCard = ({ product, id}) => {
  ...
  return (
    <div className="w-full bg-yellow-200 rounded-md m-2 p-4">
...
export default function ShopPage({ products }) {
  ...
  return (
    <div className="w-[100vw] flex justify-center items-center h-max bg-white">
      ...
      <Link className='bg-green-400 p-2 m-2'  href={'/shop2'}>Link SHOP 2</Link>
      <button className='bg-red-400 p-2 m-2' onClick={() => router.push('/shop3', '', { scroll: false})}>SHOP 3</button>
      <Link className='bg-green-400 p-2 m-2'  href={'/shop3'}>Link SHOP 3</Link>
      <button className='bg-red-400 p-2 m-2' onClick={() => router.push('/', '', { scroll: false})}>HOME</button>
